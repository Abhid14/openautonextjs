  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vehicle Maintenance From The Comfort of Your Home."
        />
      ...
      <main className="bg-primary text-white">
        ...
        <section className="container lg:mt-0 mt-4 flex lg:flex-row flex-col justify-center items-center">
          <div className="flex z-10 lg:text-left text-center flex-col gap-4 lg:gap-8 lg:items-start lg:justify-start items-center justify-center">
            ...
            <p className="font-thin text-[12px] lg:text-[14px]">
              ...
              you deal with the unexpected repairs worry-free.
            </p>
            <ContactForm />
          </div>
          <img
            className="lg:h-[520px] h-auto lg:w-auto w-[80vw] lg:mt-0 mt-12 z-10 my-2"
            src="/hHero1.png"
          />
          <img
            className="absolute lg:ml-16 h-auto lg:w-auto w-[90vw] opacity-40"
            src="/worldmap.png"
          />
        </section>
        ...
        <div className="w-full bg-secondary flex flex-col items-center justify-center">
          <section
            id="hero2"
            className="container bg-secondary items-center flex lg:flex-row flex-col lg:justify-between py-6 lg:py-8"
          >
            <img
              className="lg:order-1 mt-10 order-2 lg:h-[400px] h-auto w-[80vw] lg:w-auto lg:my-16"
              src="/hHero2.png"
            />
